...
@PrepareForTest({Connection.Builder.class, Connection.class})
class RethinkdbTest {
    ...
    public void defaultsWithCustomOption() throws Exception {
        ...
        new MockUnit(Env.class, Config.class, Binder.class)
                .expect(unit -> {
                    Config config = unit.get(Config.class);
                    expect(config.getConfig("rethinkdb"))
                            .andReturn($rethinkdb.getConfig("rethinkdb"));
    ...
    public void defaultsConfig() throws Exception {
        new MockUnit(Env.class, Config.class, Binder.class)
                .run(unit -> {
                    assertEquals($rethinkdb, new org.jooby.rethinkdb.Rethinkdb().config());
                });
    }
